    ...
    def train(self):
        ...
        for cur_epoch in range(self.model.cur_epoch_tensor.eval(self.sess), self.config.n_epochs + 1, 1):
            ...
            if cur_epoch % self.config.print_step == 0:
                pred_rate, acc, cpt_acc, mac_f1, mic_f1, exp_rt, sharpe = report_all
                ...
                pred_rate, acc, cpt_acc, mac_f1, mic_f1, exp_rt, sharpe = report_topk
            ...
            if cur_epoch % self.config.eval_step == 0:
                ...
                te_pred_rate, te_acc, te_cpt_acc, te_f1, te_mcc, te_exp_rt, te_sharpe = report_topk
